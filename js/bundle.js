...
function forms(formSelrctor, modalTimerId) {
  var forms = document.querySelectorAll(formSelrctor);
  var message = {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); //собираем при помощи FormData все наши формы
      var json = JSON.stringify(Object.fromEntries(formData.entries()));
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)('http://localhost:3000/requests', json) // из PostData нам вернется promise который мы дальше обрабатываем
      .then(function (data) {
        // с сервера вернется какая то data
        console.log(data); // data это как раз те данные которые вернулись из promis 
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2023-12-12');
